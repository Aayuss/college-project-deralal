    ...
    <div className="flex min-h-svh w-full items-center justify-center p-4 md:p-6">
      <div className="w-full max-w-md">
        <Card>
          ...
          <CardContent>
            <Tabs value={userRole} onValueChange={(value) => setUserRole(value as "rentee" | "landlord")}>
              ...
              <TabsContent value={userRole}>
                <form onSubmit={handleLogin} className="flex flex-col gap-4">
                  ...
                  <div className="text-center text-sm text-muted-foreground">
                    ...
                    <Link href={`/auth/sign-up?type=${userRole}`} className="underline underline-offset-4 hover:text-foreground">
                      Sign up
                    </Link>
                  </div>
                </form>
