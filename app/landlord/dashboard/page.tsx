...
import { Plus, Edit2, Eye, Trash2, AlertCircle, CheckCircle, Clock, DollarSign } from 'lucide-react';
...
export default function LandlordDashboard() {
  ...
  const stats = {
    ...
    active: listings.filter(l => l.is_active && l.availability_status === "available").length,
    occupied: listings.filter(l => l.availability_status === "occupied").length,
    totalRevenue: listings.reduce((acc, l) => acc + l.price, 0),
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="font-bold text-lg hidden sm:inline">deralal</span>
            </Link>
          ...
          <Card className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold mt-2 text-blue-600">{stats.occupied}</p>
              </div>
          ...
          <Card className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold mt-2 text-primary">NPR {stats.totalRevenue.toLocaleString()}</p>
              </div>
                ...
                <div className="flex items-start justify-between gap-6">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-6 text-sm">
                      <span className="font-semibold">NPR {listing.price.toLocaleString()}/month</span>
                      <span className="text-muted-foreground">{listing.bedrooms} bed, {listing.bathrooms} bath</span>
